...
const AppFooter = ({ theme }) => (
  <footer className={`mt-auto pt-4 pb-3 border-t-2 ${
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-3">
        <div className="flex items-start gap-3 max-w-2xl">
          ...
          <div className={`text-sm leading-relaxed ${
            ...
            <span className="font-semibold">Important:</span> This tool is for 2nd/3rd/4th year students only. <span className={`font-semibold ${theme === 'dark' ? 'text-red-400' : 'text-red-600'}`}>Freshers have a different academic calendar.</span>
            <br />
