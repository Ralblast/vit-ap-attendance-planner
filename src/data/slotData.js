const individualSlotDays = {
  ...
  // Tutorial slots - Cycle 2
  TA2: [4], TB2: [5], TC2: [6], TD2: [4], TE2: [5], TF2: [5], TG2: [6],
  
  // Supplementary/Lab slots
  SC1: [3], SC2: [3], 
  SD1: [5], SD2: [5], 
  SE1: [2], SE2: [6], 
  SF1: [6]
